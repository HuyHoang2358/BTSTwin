...
export const fetchProvinces = (
  country_id: Ref<string>
): WrapperResponse<Province[]> => client.get(API_ADDRESS_PROVINCE, {
    params: {
      filter: {
...
export const fetchDistricts = (
  province_id: Ref<string>
): WrapperResponse<District[]> => client.get(API_ADDRESS_DISTRICT, {
  params: {
    filter: {
...
export const fetchCommunes = (
  district_id: Ref<string>
): WrapperResponse<Commune[]> => client.get(API_ADDRESS_COMMUNE, {
  params: {
    filter: {
